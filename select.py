...
#     print(follow_dict)
#     # 2
from first_follow import getfirstandfollow
...
if __name__ == '__main__':
    expression_dict, terminal, non_terminal, first_dict, follow_dict = getfirstandfollow()
